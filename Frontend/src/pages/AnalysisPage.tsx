...
const isValidLine = (line: string): boolean => {
  ...
  const unwantedKeywords = [
    'ai assistance', 'gemini', 'non sense', 'as mentioned earlier', 
    'in conclusion', 'to summarize', 'to conclude', 'furthermore', 
    'moreover', 'as discussed above', 'let me know if you need more details',
    'this was generated by', 'i am an ai', 'based on the input provided'
  ];
